...
class Chat_model extends CI_Model
{
	...
	public function get_chat_history($user_id){
		$query = $this->db->query("select T1.user2_id, T1.chat_detail_id, CONCAT(users.first_name,' ',users.last_name) AS 'user_name',users.user_image,users.company,cdate as updated_on from
