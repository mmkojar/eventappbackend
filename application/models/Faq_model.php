...
class Faq_model extends CI_Model
{
	...
	public function register_faqs(array $register_data)
	{

		$this->db->insert('faqs', $register_data);
	...
	public function update($id, array $data)
	{
		...
		$faqs = $this->get_faqs($id);
		
		$this->db->trans_begin();

		$this->db->update("faqs", $data, array('id' => $faqs["id"]));
	...
	public function delete_($id)
	{
		...
		$this->session->set_flashdata('success', 'faq Delete Successful');
		return TRUE;
	}

	public function get_faqs_api($id=FALSE){
		$this->db->select("faqs.*");
		$this->db->from("faqs");
