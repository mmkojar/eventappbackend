...
class DPayPal {
    ...
    //API Credentials
	protected $username = "mail_api1.mrai.org.in"; //PayPal API username
    //protected $username = "mail-facilitator_api1.mrai.org.in"; //PayPal API username
    protected $password = "RDWQXA6FTGT5TFGX"; //PayPal API password
    //protected $password = "7GGC2XS4HCMT3J3Q"; //PayPal API password
    protected $apiSignature = "AiPC9BjkCyDFQXbSkoZcgqH3hpacADlzrr28i7Kv1mAUffg.3Lx8O2ZD"; //PayPal API signature 
    //protected $apiSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A24605ptt9zDFag.BH0JP4M8KKUu"; //PayPal API signature 
    protected $apiVersion = "204.0"; //Set PayPal API version
