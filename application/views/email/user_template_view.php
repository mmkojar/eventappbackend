	...
	<div class="container-fluid">
		<div class="row">
			...
			<p>
				...
				<br>
				<span>We have received your Event Registration Form and will get back to you once the form is verified.</span>
				<br>
				<br>
				<span class="sub_text">Please note that your unique email ID and Mobile No. once registered with this Event Registration Form can't be used again. 
				<br>
				In case you wish to cancel your registration please send a mail to <a href="mailto:events@mrai.org.in" target="_blank">events@mrai.org.in</a>
				</span>
			</p>
			<p>
