	...
	<div class="container-fluid">
		<div class="row">
			...
			<p>
				...
				<br>
				<span>your payment have been failed due to <?php echo $reason ?>.</span>
				<br>
				<span>Please note that your unique email ID and Mobile No. registered with this Event Registration Form can't be used again.</span>
				<span>If you want to use same email ID and Mobile No then please send a mail to <a href="mailto:events@mrai.org.in" target="_blank">events@mrai.org.in</a>. </span>
				<br>
				</span>
			</p>
			<p>
