				...
				<div class="content">
					<div class="toolbar">
						...
						<div class="fresh-datatables">
							<table id="requested_table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								<thead>
									<th>ID</th>
									<th>Name</th>
									<!--<th>Email</th>-->
	...
	$.noConflict();
		$('#requested_table').DataTable({
			...
			// Load data for the table's content from an Ajax source
			 "ajax": {
				"url": "<?php echo base_url();?>admin/requested/requested_list",
				"type": "POST"
			},
