				...
				<div class="content">
					<div class="toolbar">
						...
						<div class="fresh-datatables">
							<table id="upload_device_table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								<thead>
									<th>Sr No.</th>
									<th>User Name</th>
									<th>File Name</th>
...
<script type="text/javascript">
	...
	$.noConflict();
		$('#upload_device_table').DataTable({
			"processing": true, //Feature control the processing indicator.
			"serverSide": true, //Feature control DataTables' server-side processing mode.
			// Load data for the table's content from an Ajax source
			"ajax": {
				"url": "<?php echo base_url();?>admin/uploads/excel_list",
				"type": "POST"
			},
