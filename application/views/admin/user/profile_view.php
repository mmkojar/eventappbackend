				...
				<div class="col-md-4">
					<div class="card card-user">
						...
						<div class="content">
							<div class="author">
								<a href="javascript:;">
								<img class="avatar border-gray" src="<?php echo ($user->user_image !== null) ? base_url($user->user_image) : base_url('assets/admin/img/default-avatar.png'); ?>" alt="..." id="OpenImgUpload"/>
					...
					<div class="card">
						...
						<div class="content">
							<?php $this->load->view('public/themes/default/error_msg'); ?>						 
								...
								<input type="hidden" name="hidden_image" value="<?php echo $user->user_image ?>" />
								<div class="row">
									<div class="col-md-12">
										<?php echo form_submit('submit', 'Update Profile', 'class="btn btn-fill btn-info btn-wd"');?>
										<br>
										<br>
										<span class="text-danger">Click on Avatar to Change it</span>
									</div>
								</div>
