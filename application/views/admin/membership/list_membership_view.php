...
<div id="content">
	...
	<a href="<?php echo site_url('admin/membership/create');?>" class="btn btn-info btn-fill btn-wd" style='margin:10px'>Add Membership</a>
				...
				<div class="content">
					<div class="toolbar">
						...
						<div class="fresh-datatables">
							<table id="membership_table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								<thead>
									<th>ID</th>
									<th>Company Name</th>
	...
	$.noConflict();
		$('#membership_table').DataTable({
			...
			// Load data for the table's content from an Ajax source
			 "ajax": {
				"url": "<?php echo base_url();?>admin/membership/membership_list",
				"type": "POST"
			},
