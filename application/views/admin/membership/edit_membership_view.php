					...
					<?php echo form_open('',array('id'=>'addMembership'));?>
						...
						<div class="form-group">
							<?php
								...
								echo form_input('membership_number',set_value('membership_number',$membership["membership_number"]),'class="form-control"  required ="true"');
							?>
						</div>
						<div class="form-group">
							<?php
								...
								echo form_input('company_name',set_value('company_name',$membership["company_name"]),'class="form-control"  required ="true"');
							?>
						</div>
						<br>
						<?php echo form_hidden('membership_id',$membership["membership_id"]);?>
						<?php echo form_submit('submit', 'Edit Membership', 'class="btn btn-info btn-fill btn-wd"');?>
						<?php echo form_close();?>
					</div>
				</div>
			</div>
