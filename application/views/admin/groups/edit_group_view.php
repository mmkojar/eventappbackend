					...
					<div class="content">
						<div class="form-group">
							<?php 
								...
								echo form_input('group_name',set_value('group_name',$group->name),'class="form-control" required ="true"');
							?>
						</div>
						<div class="form-group">
							<?php 
								...
								echo form_input('group_description',set_value('group_description',$group->description),'class="form-control" required ="true"');
							?>
						</div>
						<br>
						<?php
							echo form_hidden('group_id',set_value('group_id',$group->id));
							echo form_submit('submit', 'Edit group', 'class="btn btn-info btn-fill btn-wd"');
							echo form_close();
						?>
					</div>
				</div>
